...
SpecexR_app <- function(...) {
  ...
  ui <- navbarPage( h3("Forestry Phenomics"),position = c( "fixed-top" ),
                                  ...
                                  sidebarPanel(width = 4,
                                               ...
                                               fluidRow(
                                                 ...
                                                 wellPanel(column(6,downloadButton('downloadPlotPNG11','Download single layer TIF')),
                                                           column(6,downloadButton('downloadPlotPNG22','Download RGB TIF')))
                                               )
                    ...
                    tabPanel(h4( "Tree identification and spectra extraction"),
                             fluidPage(
                               ...
                               sidebarLayout(
                                 ...
                                 font-family:'Yusei Magic';
                                                         ...
                                                         tags$head(tags$style("#statdata{color: green;
                                 font-size: 50px;
                                 font-weight: bold;
                                  background-color:white;
                                 font-family:'Yusei Magic';
                                 ...
                                 mainPanel(
                                   ...
                                   fluidRow( column(4,sliderInput(inputId = 'wscontro',
                                   ...
                                   fluidRow(
                                     column(6, downloadButton('downloadrgball',
                                                              'Downloadrgb',class = "butt1")) ,

                                     column(6,  downloadButton('downloadsfall','Downloadshp',class = "butt1") )
                                   ...
                                   tabsetPanel(type = "tabs",
                                               ...
                                               tabPanel("LAS polt information",
                                                        sidebarPanel(
                                                          fluidRow(
                                                            column(12, actionButton("dodo", "Plot las point cloud")),
                                                            tags$hr(),
                                                            column(12, actionButton("drawpolyroi", "Plot ROI point cloud")),
                                                            tags$hr(),
                                                            column(12, actionButton("dodo1", "Plot single tree point cloud")),
                                                            tags$hr(),
  ...
  server <- function(input, output) {
    ...
    output$plotfinalresult  <- renderPlot({
      finalda  <- finaldata()
      nir <- filter(finalda, treeID == input$select2 )
      re <- names(nir)
